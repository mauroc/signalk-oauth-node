...
module.exports = function(passport){
    ...
    router.get("/api_example_1",  function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/vessels/");
    });
    ...
    router.get("/api_example_2", function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/vessels/self");
    });
    ...
    router.get("/api_example_3", function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/vessels/imo:mmsi:215*");
    });
    ...
    router.get("/api_example_4", function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/vessels/self/navigation?friends=true" );
    });
    ...
    router.get("/api_example_5", function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/vessels/self/navigation?within_range=20" );
    });
    ...
    router.get("/api_example_6",  function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/resources/waypoints/country/US?region_code=CA");
    });
    ...
    router.get("/api_example_7",  function(req, res){
        ...
        auth_get(req, res, authServer+"/signalk/v1/api/resources/waypoints/vessels/self?within_range=20" );
    });
    ...
    router.get("/api_example_8",  function(req, res){
        ...
        auth_post(req, res, authServer+"/signalk/v1/api/vessels/navigation/position.json" );
    });
